	    ...
	    public static $picture_1;  
			...
			private static function get_demotivator_id(){
		  	...
		  	public function get_page_id(){
                                ...
                                $get_post_id = $wpdb->get_var("SELECT * FROM `".$wpdb->prefix."posts` WHERE `post_title` = 'Demotivators' AND `post_name` = 'Demotivational-posters' LIMIT 1"); 
			...
			public function get_url_last_and_first_page($url_type){
			            ...
			            if($url_type == true){
															   ...
															   $code.='<a href="'.$next.'"> <img class="fun_demotivator_float_right"  src="http://demotivators.us/img/forward.png"> </a>';
                                                               //======================= 
															   ...
															   $next_page = str_replace('?&','?',$next_page);
															   $code.='<a href="'.$next.'"> <img class="fun_demotivator_float_left" src="http://demotivators.us/img/previous.png"> </a>';
                                                               //======================= 
    ...
    function import_images(){
	           ...
	           $demot_import = new demotivators;	         
			            ...
			            elseif( $demot_import->check_current_page() == 2 ){
									  ...
									  echo'<a  href="'.$prev_url.'" ><img class="fun_demotivator_float_left" src="http://demotivators.us/img/previous.png" /></a>';  
									  echo'<a  href="'.$next_url.'" ><img class="fun_demotivator_float_right" src="http://demotivators.us/img/forward.png" /></a>';  
